...
import spring.scheduler.utils.QuickLinkAuthFilter;

@Configuration
@EnableWebSecurity
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	//now is impossible to autowire it in constructor, because it goes to loop dependencies due to BCryptPasswordEncoder bean, so:
	@Autowired
